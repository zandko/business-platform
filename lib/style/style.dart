...
class GZIcons {
  ...
  static const IconData home =
      const IconData(0xe6b8, fontFamily: GZIcons.FONT_FAMILY);
  static const IconData home_active =
      const IconData(0xe652, fontFamily: GZIcons.FONT_FAMILY);

  static const IconData we_tao =
      const IconData(0xe6f5, fontFamily: GZIcons.FONT_FAMILY);
  static const IconData we_tao_fill =
      const IconData(0xe6f4, fontFamily: GZIcons.FONT_FAMILY);

  static const IconData message =
      const IconData(0xe6bc, fontFamily: GZIcons.FONT_FAMILY);
  static const IconData message_fill =
      const IconData(0xe779, fontFamily: GZIcons.FONT_FAMILY);

  static const IconData cart =
      const IconData(0xe6af, fontFamily: GZIcons.FONT_FAMILY);
  static const IconData cart_fill =
      const IconData(0xe6b9, fontFamily: GZIcons.FONT_FAMILY);

  static const IconData my =
      const IconData(0xe78b, fontFamily: GZIcons.FONT_FAMILY);
  static const IconData my_fill =
      const IconData(0xe78c, fontFamily: GZIcons.FONT_FAMILY);
